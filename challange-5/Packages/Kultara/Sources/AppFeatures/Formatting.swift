...
public struct ContentFormatter: Sendable {

    public let language: ContentLanguage
    public let locale: Locale

    public init(language: ContentLanguage) {
    ...
    public func distance(metres: Int) -> String {
        if metres < 1000 {
    ...
    public func cost(amount: Int, currency: String) -> String {
    ...
    public func time(_ time: TimeOfDay, calendar: Calendar = .current) -> String {
    ...
    public func window(_ window: StartWindow, calendar: Calendar = .current) -> String {
    ...
    public func photoPolicy(_ level: PhotoPolicyLevel) -> String {
        switch level {
    ...
    public func accuracyLabel(_ accuracy: AccuracyLabel) -> String {
        switch accuracy {
