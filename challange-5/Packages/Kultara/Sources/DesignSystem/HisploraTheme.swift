...
public struct HisploraPalette: Sendable, Equatable {
    ...
    // Grounds — the two browns the frames alternate between.
    /// The deepest ground: story reveal, location screens, transition.
    public let brownDeep: SRGBColor
    /// A step lighter, used as the full-bleed ground on the cutscene frames and as the fill of the
    /// circular pager control.
    ...
    /// Sampled 2026-08-13 from frames `81:588`, `81:617`, `89:1402`, `223:2004`, `98:1588`,
    /// `187:866`, `105:1699`, `187:954`, `187:1053`, `187:1103`.
    ///
    /// Two values are not the design's. `inkDusty` was `#CBAFA8` and measured 4.42:1 on `brownMid`,
    /// four hundredths under the threshold; it is lightened to the nearest passing value.
    /// `buttonRing` does not exist in the design at all and is added for the reason given on the
    /// property. Everything else is as drawn.
    public static let standard = HisploraPalette(
        ...
        inkCream: SRGBColor(hex: "#FDF2DE"),      // 9.63:1 on brownDeep, 8.17:1 on brownMid
        inkDusty: SRGBColor(hex: "#CDB1AA"),      // moved from #CBAFA8; 4.52:1 on brownMid
    ...
    public var allTokens: [(name: String, value: SRGBColor)] {
        [("brownDeep", brownDeep), ("brownMid", brownMid),
